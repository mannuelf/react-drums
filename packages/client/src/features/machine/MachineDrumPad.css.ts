...
export const machineDrumPadStyle = style({
  ...
  selectors: {
    ...
    '&:nth-child(9)': { backgroundColor: '#fc9824', order: 5 },
    '&:nth-child(10)': { backgroundColor: '#fc9824', order: 6 },
    '&:nth-child(11)': { backgroundColor: '#fc9824', order: 7 },
    '&:nth-child(12)': { backgroundColor: '#fc9824', order: 8 },
    '&:nth-child(13)': { backgroundColor: '#19eaa3', order: 1 },
    '&:nth-child(14)': { backgroundColor: '#19eaa3', order: 2 },
    '&:nth-child(15)': { backgroundColor: '#19eaa3', order: 3 },
    '&:nth-child(16)': { backgroundColor: '#19eaa3', order: 4 },
  },
});
