...
import { machineColumn, machineHeader, machineHeaderLcd, machineHeaderLcdContainer, machineHeaderLogo, machineSubTitle, machineTitle } from './MachineHeader.css';
        ...
        <div className={machineColumn}>
          <div className={machineHeaderLcd}>
            <hgroup className={machineHeaderLcdContainer}>
              ...
              <h2 className={machineSubTitle}><span>KIT</span> 808</h2>
            </hgroup>
          </div>
        </div>
      </header>
